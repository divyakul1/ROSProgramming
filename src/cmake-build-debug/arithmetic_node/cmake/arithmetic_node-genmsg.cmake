...
set(MSG_I_FLAGS "-Iarithmetic_node:/home/divyak/catkin_ws/src/arithmetic_node/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/divyak/catkin_ws/src/arithmetic_node/msg/arithmetic_reply.msg" NAME_WE)
add_custom_target(_arithmetic_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arithmetic_node" "/home/divyak/catkin_ws/src/arithmetic_node/msg/arithmetic_reply.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(arithmetic_node
  "/home/divyak/catkin_ws/src/arithmetic_node/msg/arithmetic_reply.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arithmetic_node)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arithmetic_node\")")
  # install generated code
  install(

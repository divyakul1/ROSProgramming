...
get_filename_component(_filename "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv" NAME_WE)
add_custom_target(_counter_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "counter_node" "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv" ""
)
...
_generate_srv_cpp(counter_node
  "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_eus(counter_node
  "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/counter_node
)

### Generating Module File
_generate_module_eus(counter_node
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/counter_node
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(counter_node_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(counter_node_generate_messages counter_node_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv" NAME_WE)
add_dependencies(counter_node_generate_messages_eus _counter_node_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(counter_node_geneus)
add_dependencies(counter_node_geneus counter_node_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS counter_node_generate_messages_eus)
...
### Generating Services
_generate_srv_nodejs(counter_node
  "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/counter_node
)

### Generating Module File
_generate_module_nodejs(counter_node
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/counter_node
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(counter_node_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(counter_node_generate_messages counter_node_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/divyak/catkin_ws/src/counter_node/srv/counter.srv" NAME_WE)
add_dependencies(counter_node_generate_messages_nodejs _counter_node_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(counter_node_gennodejs)
add_dependencies(counter_node_gennodejs counter_node_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS counter_node_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/counter_node)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/counter_node
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(counter_node_generate_messages_eus std_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/counter_node)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/counter_node
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(counter_node_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()

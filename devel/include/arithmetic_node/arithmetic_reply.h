...
struct arithmetic_reply_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _oper_type_type;
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'arithmetic_node': ['/home/divyak/catkin_ws/src/arithmetic_node/msg']}
...
struct Printer< ::arithmetic_node::arithmetic_reply_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::arithmetic_node::arithmetic_reply_<ContainerAllocator>& v)
  {
    ...
    s << indent << "oper_type: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.oper_type);
    s << indent << "answer: ";
